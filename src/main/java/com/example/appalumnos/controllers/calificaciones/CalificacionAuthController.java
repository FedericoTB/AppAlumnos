...
@RestController
@RequestMapping(APIConfig.API_PATH +"/auth/calificaciones")
public class CalificacionAuthController {
    private final CalificacionMapper calificacionMapper;
    private final CalificacionRepository calificacionRepository;

    @Autowired
    public CalificacionAuthController(CalificacionMapper calificacionMapper, CalificacionRepository calificacionRepository) {

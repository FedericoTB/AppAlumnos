...
@RestController
@RequestMapping(APIConfig.API_PATH +"/auth/alumnos")
public class AlumnoAuthController {
    private final AlumnoMapper alumnoMapper;
    private final AlumnoRepository alumnoRepository;

    @Autowired
    public AlumnoAuthController(AlumnoMapper alumnoMapper, AlumnoRepository alumnoRepository) {
